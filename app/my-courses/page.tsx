...
import type { TrackedCourse } from '@/lib/types';
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        ...
        <p className="mt-1 text-sm" style={{ color: 'var(--muted)' }}>Track learning progress.</p>
      </div>
      ...
      <div className="card p-5">
        ...
        {loadingTracked ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-xs" style={{ color: 'var(--muted)' }}>Add courses via Gap Analysis to start tracking your learning</p>
          </div>
        ) : (
