              ...
              <div className="grid grid-cols-3 gap-2">
                {USER_TYPE_OPTIONS.map(opt => (
                  ...
                  >
                    ...
                    <span className="text-xs font-semibold" style={{ color: userType === opt.value ? 'var(--primary)' : 'var(--foreground)' }}>
                      {opt.label}
                    </span>
              ...
              <div className="space-y-4 pt-1">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    className="input"
                    placeholder={userType === 'working_adult' ? 'e.g. DBS Bank' : 'e.g. Last company or N/A'}
                    value={company}
