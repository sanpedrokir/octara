...
const NAV_SECTIONS: { label: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/company-jobs',     icon: '🏢', label: 'Jobs by Company',  description: 'Search and browse latest job postings by Singapore employer.', color: '#7c3aed', bg: '#f5f3ff', border: '#ddd6fe' },
